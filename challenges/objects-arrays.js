...
const graduates = [{
  ...
  },
  {
    "id": 10,
    "first_name": "Hube",
    "raduates": "Universitat Rovira I Virgili Tarragona",
...
const list = [];
for (let i = 0; i < graduates.length; i++) {
  list.push(graduates[i].university);
}
console.log(list);
...
*/
const animalNames = [];
let allInOne = zooAnimals.forEach(function (i) {
